<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col = array();
		$col["title"] = "USER TYPE ID"; // caption of column
		$col["name"] = "user_type_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "30"; 
		...
		$col["editrules"] = array("required"=>true,"type"=>true,"limit"=>true); // and is required
		...
		$grid["caption"] = "USER DATA"; // caption of grid
...
$g->select_command = "SELECT * FROM user_master";


"SELECT * FROM (SELECT i.id, invdate , c.name,
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="usermanage.php">Usertype</a></li>
