<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$grid["sortname"] = 'course_id'; // by default sort grid by this field
...
$g->select_command = "SELECT * FROM course_master";

// this db table will be used for add,edit,delete
$g->table = "course_master";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="coursemanage.php">Course</a></li>
