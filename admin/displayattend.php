<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col = array();
		$col["title"] = "Total Present";
		$col["name"] = "tot_present";
		$col["width"] = "20"; // not specifying width will expand to fill space
		$col["sortable"] = false; // this column is not sortable
		$col["search"] = true; // this column is not searchable
		$col["editable"] = true;
		$col["editrules"] = array("required"=>true,"integer"=>true,"pre"=>true); // and is required
		...
		$grid["caption"] = "Student Attendance Data"; // caption of grid
...
$g->select_command = "SELECT e.id,e.att_id,e.stud_id,e.sub_id,e.tot_present,e.division,s.sub_name  FROM stud_attend_master as e inner join sub_master as s on e.sub_id=s.sub_id";

// this db table will be used for add,edit,delete
$g->table = "stud_attend_master";
...
<head><title>Display Attendance</title>
...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="#"><b>Upload</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="displayattend.php">Display Attendance</a></li>
