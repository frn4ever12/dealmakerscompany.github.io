<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col = array();
		$col["title"] = "Down Id"; // caption of column
		$col["name"] = "down_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "18";
		...
		$col["editoptions"] = array("value"=>'1:BCA;2:BBA;3:B.Com;4:PTC;5:BED');
		$cols[] = $col;
		...
		$col["search"] = true; // this column is not searchable
		$col["editable"] = false;
		$col["editrules"] = array("required"=>true,"integer"=>true,"no"=>true);
		...
		$col["width"] = "30";
		$col["edittype"] = "select"; // render as select
		$col["editoptions"] = array("value"=>'assignment:assignment;gallery:gallery;syllabus:syllabus;timetable:timetable;blacklist:blacklist');
		$col["editable"] = true;
		$cols[] = $col;
		...
		$grid["sortname"] = 'down_id'; // by default sort grid by this field
		$grid["sortorder"] = "asc"; // ASC or DESC
		$grid["caption"] = "Semester Data"; // caption of grid
		$grid["autowidth"] = true; // expand grid to screen width
		$grid["multiselect"] = true;
		$grid["export"] = array("filename"=>"my-file", "sheetname"=>"test");  // allow you to multi-select through checkboxes
// RTL support
// $grid["direction"] = "rtl";
...
$g->set_actions(array(	
						...
						"autofilter" => true,"export"=>true,"search" => "advance"
						 // show/hide autofilter for search
					) 
				);

// you can provide custom SQL query to display data
$g->select_command = "SELECT s.down_id,s.down_title,s.down_type,s.path,IF(s.course_id='1','BCA',IF(s.course_id='2','BBA',IF(s.course_id='3','BCOM',IF(s.course_id='4','PTC','BED')))) as course_id FROM download_master as s";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li  class="sub_show"><a href="downloadmanage.php">Download</a></li>
