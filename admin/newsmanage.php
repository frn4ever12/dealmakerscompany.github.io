<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col = array();
		$col["title"] = "News Id"; // caption of column
		$col["name"] = "news_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "18";
		...
		$col = array();
		$col["title"] = "News Name"; // caption of column
		$col["name"] = "news_name"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "35";
		$col["editrules"] = array("required"=>true,"nname"=>true); // and is required
		$col["editable"] = true;
		# $col["hidden"] = true; // hide column by default
		$cols[] = $col;	
		...
		$col["align"] = "center";
		$col["editrules"] = array("required"=>true,"date"=>true); // this column is not editable
		...
		$col["editrules"] = array("required"=>true,"dis"=>true);// render as textarea on edit
		$col["editoptions"] = array("rows"=>5,"cols"=>30); // with these attributes
		$cols[] = $col;

		$col = array();
		$col["title"] = "Download Id";
		$col["name"] = "down_id";
		$col["width"] = "30"; // not specifying width will expand to fill space
		$col["sortable"] = false; // this column is not sortable
		$col["search"] = true; // this column is not searchable
		$col["editable"] = false;
		$col["editrules"] = array("required"=>true);// render as textarea on edit
		$col["editoptions"] = array("rows"=>5,"cols"=>30); // with these attributes
		$cols[] = $col;
		...
		$grid["sortname"] = 'news_id'; // by default sort grid by this field
		$grid["sortorder"] = "asc"; // ASC or DESC
		$grid["caption"] = "News Data"; // caption of grid
...
$g->select_command = "SELECT * FROM news_master";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="newsmanage.php">News</a></li>
