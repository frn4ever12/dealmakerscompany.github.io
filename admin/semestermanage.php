<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col = array();
		$col["title"] = "Sem Id"; // caption of column
		$col["name"] = "sem_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "18";
		...
		$col["edittype"] = "select"; // render as select
		$col["editoptions"] = array("value"=>'FY:FY;SY:SY;TY:TY');
		...
		$col = array();
		$col["title"] = "Total Subject";
		$col["name"] = "total_sub";
		$col["editrules"] = array("required"=>true,"integer"=>true,"zero"=>true,"sub"=>true);
		$col["width"] = "30";
		$col["editable"] = true;
		$cols[] = $col;
		...
		$grid["sortname"] = 'sem_id'; // by default sort grid by this field
...
$g->select_command = "SELECT s.sem_id,s.sem_no,s.year,s.total_sub,IF(s.course_id='1','BCA',IF(s.course_id='2','BBA',IF(s.course_id='3','BCOM',IF(s.course_id='4','PTC','BED')))) as course_id FROM sem_master as s";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="semestermanage.php">Semester</a></li>
