...
<title>Vivekanand College Login Page</title>
...
<img src="logo.png" width="" height="135" style="margin-bottom:px;margin-left:-350px;margin-top:-290px;">
<H6 style="margin-top:-138px;margin-left:-190px;font-size:15px;color:#FFFFF0;display: block;">Managed By Abhinav Education Trust, Jahangirpura</h6>
<H6 style="margin-top:-15px;margin-left:400px;font-size:15px;color:#FFFFF0;" >Affiliated To Veer Narmad South Gujarat University</h6>
<H6 style="margin-top:30px;margin-left:-175px;font-size:35px;color:#FFFFF0;">VIVEKANAND COLLEGE FOR BCA,BBA,B.COM,B.Ed,PTC </b></h6>
	</div>
	<!-- end logo -->
...
{
$to = $_POST['email'];
$from = "nakranichetan32@yahoo.com";
...
echo "Message has been sent....!";
	...
	if(isset($_POST['s1']))
	{
		...
		if($con)
		{
			mysql_select_db("vvkcollege",$con1);
		}
		else
		{
			echo "Connection is not Est"."<br>";
