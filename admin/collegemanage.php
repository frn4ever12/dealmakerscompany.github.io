<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col["name"] = "info_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "15";
		$col["editable"] = true; 
		...
		$col["editoptions"] = array("value"=>'college his:college his;diretor msg:diretor msg;principal msg:principal msg');
		...
		$grid["sortname"] = 'info_id'; // by default sort grid by this field
		$grid["sortorder"] = "asc"; // ASC or DESC
		$grid["caption"] = "Collegeinfo Data"; // caption of grid
...
$g->select_command = "SELECT i.info_id,i.info,i.info_type FROM collegeinfo_master as i";

// this db table will be used for add,edit,delete
$g->table = "collegeinfo_master";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="collegemanage.php">College Info</a></li>
