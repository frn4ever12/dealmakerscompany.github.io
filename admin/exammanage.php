<?php
	...
	if($_SESSION['username']!="")
	{
		...
		$col = array();
		$col["title"] = "Exam Id"; // caption of column
		$col["name"] = "exam_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "18";
		...
		$col["search"] = true; // this column is not searchable
		$col["edittype"] = "select"; // render as select
		$col["editoptions"] = array("value"=>'Internal-1:Internal-1;Internal-2:Internal-2');
		...
		$grid["sortname"] = 'exam_id'; // by default sort grid by this field
		$grid["sortorder"] = "asc"; // ASC or DESC
		$grid["caption"] = "Exam  Data"; // caption of grid
...
$g->select_command = "SELECT e.exam_id,IF(e.course_id='1','BCA',IF(e.course_id='2','BBA',IF(e.course_id='3','B.COM',IF(e.course_id='4','PTC','B.ED')))) as course_id,e.sem_id,e.examtype,e.duration,e.declard,e.status_tt,s.sem_no  FROM exam_master as e inner join sem_master as s on e.sem_id=s.sem_id";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="exammanage.php">Exam</a></li>
