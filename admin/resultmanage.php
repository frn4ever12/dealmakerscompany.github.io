...
$g->select_command = "SELECT e.id,e.exam_id,e.stud_id,e.sub_id,e.marks,e.division,s.sub_name  FROM result_master as e inner join sub_master as s on e.sub_id=s.sub_id";

// this db table will be used for add,edit,delete
$g->table = "result_master";
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a href="resultmanage.php">Result</a></li>
