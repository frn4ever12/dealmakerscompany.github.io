...
<li><a href="showattendancebba.php" title="Drop down menu 1">BBA</a></li>
						
<li><a href="" title="Drop down menu 1">BCOM</a></li>
                                ...
                                <tr>
                                    <td bgcolor="#e8eefa" align="center" valign="top" >
                                        <table class="Search" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                               <td class="tdodd" style='font-family: Verdana, Helvetica, sans-serif;font-size:14px;color:#1F1F1F;font-weight:bold'>
                                                    Attend.
                                                </td>
                                                <td>
</form>
...
$res=mysql_query("SELECT att_id,start_date,end,course_id,sem_id from attend_master where declard='Yes' and course_id=3;");
...
<td valign="top" valign="top">
						...
						{
						?>
                                                    <img id="imgresult" src="../result/Exlam-small.gif" style="border-width:0px;vertical-align: bottom; height: 14px;" />
                                                     &nbsp;SEARCH ATTENDANCE :
						<?php
						}
						else
						{
						?>
							<img id="imgresult" src="../result/Right.png" style="border-width:0px;vertical-align: bottom; height: 14px;" />
                                                     &nbsp;SEARCH  ATTENDANCE :
						<?php
						}?>
                                                </td>
						...
						else
						{
							...
							echo $fullname;
                                            ...
                                            <tr id="tronlymap">
	<td class="Stdtxt tdodd" style='font-family: Verdana, Helvetica, sans-serif;font-size:16px;color:#1F1F1F'>
                                                   <b> Stud. ID 
                                                </td>
						<td colspan="3" style='font-family: Verdana, Helvetica, sans-serif;font-size:14px;color:#1F1F1F'>
