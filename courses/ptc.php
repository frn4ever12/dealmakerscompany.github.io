...
<title>PTC Programme Details</title>
...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Importance of P.T.C Programme</h2>
	
									

<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li>PTC means Primary Teacher Certificates. It is a course for the student who wants to be a primary teacher. It is two years course. The trainees have to complete their training of elementary teaching in two years.
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Information for Admission</h2>

<li style="margin-top:10px;"> After passing twelve standard (12th) standard the student is eligible to get admission in P.T.C Whatever Stream you have in standard 12th ,arts, commerce or science but you are eligible to get admission in P.T.C as their is centralized admission process.Thier are reserve seats for different categories.
<br><center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">What is the career after doing BBA ?</h2>
<li>You may be a primary teacher after completion of P.T.C. Gujarat State Education Board is asking for P.T.C. qualification for recruitment of VIDYA SAHAYAK. So you may get a very good job in very short time.
...
<h3></h3>
<br>
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">P.T.C Programme Deatils </h2>
		...
		<table class="features-table">
				...
				<tbody>
					<tr>
						...
						$res=mysql_query("SELECT * from course_master where course_id=4;");
...
<h3></h3>
<br>	
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Subject Deatils of P.T.C Programme</h2>

<br>
<h1  style="font: bold 1.3em 'trebuchet MS', 'Lucida Sans', Arial;">Sem No / Year:
<select name="se"  size="1" style="width:40px;">
<?php
$res=mysql_query("SELECT * from sem_master where course_id=4;");
...
<div class="post" style="width:800px;">
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Fees Details Of P.T.C Programme</h2>
	
									

<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li>Fees are taken according to rules and regulations of GSEB. It is as following...
College Fees        :    Rs. 20,000/-
</ul>	
 </center>
<h2 style="margin-top:8px;margin-left:12px;">
