...
<title>BCOM Programme Details</title>
...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Importance of B.COM Programme</h2>
	
									

<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li>B.Com. stands for Bachelor in Commerce. This course provides the bachelor degree  training in commerce and related discipline. It is a three year course which is affiliated to South Gujarat University, Surat India.

<center><h2 style="margin-left:px;margin-top:;font-size:20px;px;">What is the Eligibility Criteria ... ?</h2>
<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li>The applicant must have passing marks in XII Commerce stream. The candidate other than Gujarat Secondary School Board must get an eligibility certificate from South Gujarat university.


<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Importance of B.COM Programme</h2>
<li>After the admission forms are received a merit list is prepared. The admission is done strictly in order of merit and preference given by the candidate, observing the University rules. After the admission is given the candidate has to pay the deposit at the counter of the college and pay the entire fee with in three days, failing which admission will be cancelled and wait listed candidate will be given admission.

		
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Educational Structure</h2>

<li>It is divided in both practical and theoretical exams. Teaching and Evaluation scheme for Primary Teacher Certificate. It is divided into Internal & External Evaluation.
...
<h3></h3>
<br>
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">B.COM Programme Deatils </h2>
		...
		<table class="features-table">
				...
				<tbody>
					<tr>
						...
						$res=mysql_query("SELECT * from course_master where course_id=3;");
...
<h3></h3>
<br>	
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Subject Deatils of B.COM Programme</h2>

<br>
<h1  style="font: bold 1.3em 'trebuchet MS', 'Lucida Sans', Arial;">Sem No/Year :
<select name="se"  size="1" style="width:40px;">
<?php
$res=mysql_query("SELECT * from sem_master where course_id=3;");
...
<div class="post" style="width:800px;">
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Fees Details Of B.COM Programme</h2>
	
									

<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li>At the time of Admission Deposit amount will be taken as  Rs. 1000. That amount will be refundable after successfully completion of  the Course. 

First Year B.Com Students have to  pay  Rs. 2540 as tuition fees per year. Second year and Third year student have to pay Rs. 4440 as tuition fees per year. This fee structure  is changeable as per the University rules.
