...
<title>BED Programme Details</title>
...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Importance of B.ED Programme</h2>
	
									

<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li>B.Ed is the abbreviation of Bachelor or Education.  B.Ed obtains the course content to prepare the best teachers for society.  Its not a general qualification but compulsory degree for being a teacher of Madhyamik shikshan board or schools affiliated to the state school education boards. the learners in B.Ed are called pupil teacher's.

During the academic session of one year pupil techer learns how to teach students of secondary or higher secondary section. They get knowledge of different philosophers about teaching learning. They come to know about psychological analysis for the   teaching learning process.  While B.Ed training pupil-teacher face the practical class- room problems during teaching practice and they come to know bout the solutions of those problems. They learn teamwork, group discussions, calibrations, co-operations, and co-ordinations during different curricular and co-curricular activities.

The curriculum of B.Ed is distinguished in two parts. First part is of theory paper which is conducted by the university for 500 minimum marks. second part is of co-curricular and extra curricular activities including lesion of teaching practice and off campus schedules.  Second part is of 500 minimum marks, which are, arrange internally by the institutions on the basis of terms and conditions given by university.

<li style="margin-top:10px;"> Even we came across with many revolutionary phases in the management discipline during the last Give decades. Once again when we are going liberalisatim , privatization and globalization we have accepted the importance of management in today's competitive environment and are looking for various management carriers.
<li style="margin-top:10px;"> Thus, Bachelor of Business Administrative is the 3 years degree course which prepare the feuture managers who may take the rapid environmental changes positively and find the opportunities to prove their managerial capabilities in different areas.
<form method="post">
</ul>	
 </center>
...
<h3></h3>
<br>
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">B.ED Programme Deatils </h2>
		...
		<table class="features-table">
				...
				<tbody>
					<tr>
						...
						$res=mysql_query("SELECT * from course_master where course_id=5;");
...
<h3></h3>
<br>	
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Subject Deatils of B.ED Programme</h2>

<br>
<h1  style="font: bold 1.3em 'trebuchet MS', 'Lucida Sans', Arial;">Sem No / Year:
<select name="se"  size="1" style="width:40px;">
<?php
$res=mysql_query("SELECT * from sem_master where course_id=5;");
...
<div class="post" style="width:800px;">
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">Fees Details Of B.ED Programme</h2>
	
									

<ul type="circle" style="color:#6E6E6E;font: 18px Arial, Helvetica, sans-serif;margin-left:25px;text-align:justify;">
<li> The fees for self-finance B.Ed colleges affiliated to south Gujarat Universities are 30,000 for total course of one year.</ul>	
 </center>
<h2 style="margin-top:8px;margin-left:12px;">
