...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Following link of Photo Gallery Allbum</h2>
...
<td>
<a href="viewalbum.php?downid=<?php echo $id;?>"><?php echo $row['down_title'];
$cn++;?></a>
</td>
</tr>
<?php
